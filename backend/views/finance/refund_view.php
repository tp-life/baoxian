                                    ...
                                    <div class="col-xs-10">
                                        <table  class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <th class="font-grey-salsa">本次可退卡金额</th>
                                                <td class="font-red-thunderbird"><?= $model->back_price; ?></td>
                                            </tr>
                                            <tr>
                                                <th class="font-grey-salsa">本次实际退金额</th>
                                                <td class="font-purple-seance sbold"><?= $model->real_back_price; ?></td>
                                                <th></th>
                                                <td></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <?php if($model->status === \common\models\CardRefund::_RF_STATE_TO_WAIT): ?>
                                                <tr>
                                                    <th>退回处理</th>
                                                    <td colspan="8" class="font-red-thunderbird sbold" id="refund_warinning">本批次已发放卡券总金额<span>￥ <?=$pay_info->send_total_price?></span>，未发放卡券总金额：￥<?php echo $wait_send?>，已收款：<span>￥<?=$pay_info->received_price?></span>
                                                        ，本次可退卡金额：<span>￥ <?=$model -> back_price?> </span>。建议退款金额：<span class="font-purple-seance">￥ <?php
                                                           echo $sy;
                                                            ?></span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td></td>
                                                    <td>
                                                        <?= \yii\helpers\Html::a('确认退卡','#',['class'=>'btn font-green-sharp sbold','title'=>'确认','id'=>'rf_confirm_done']) ?>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
