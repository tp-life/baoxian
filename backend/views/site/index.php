                                    ...
                                    <?php foreach ($result as $val):
                                        ...
                                        switch ($val['type']) {
                                            ...
                                            case 'assigned':
                                                ...
                                                $href = Yii::$app->urlManager->createUrl(['ordermainten/view', 'id' => $val['m_order_id']]);
                                                break;
                                            default :
                                                $msg = '';
                                                $msg_color = '';
                                        ...
                                        <li class="row">
                                            ...
                                            <div class="col-sm-3 text-right">
                                                ...
                                                <div
                                                    class="date ">
                                                    <span>
                                                        <?=\common\models\Seller::getSeller($val['send_id'])->seller_name?>
                                                    </span>
                                                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    <span><?= date('Y-m-d H:i', $val['add_time']) ?></span>
                                                </div>
...
<script type="text/javascript">
    ...
    function handleMsg(id,url){
        $.post('<?=Yii::$app->urlManager->createUrl('site/handlemsg')?>',{id:id,'_csrf-backend': $('meta[name="csrf-token"]').attr("content")},function(data){
            if (data.code == 'yes') {
