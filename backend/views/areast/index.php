...
<div class="portlet light portlet-fit portlet-datatable bordered">
	...
	<div class="portlet-title">
		...
		<div class="actions">
			<a attr-url="<?=Yii::$app->urlManager->createUrl('areast/export')?>"  id="order-download"
                ...
                <div class="table-search text-right">
					...
					<div class="col-sm-3 col-sm-offset-9" style="margin-bottom: 8px">
						<input type="text" id="citySel" class="form-control"   readonly style="width: 75%;display: inline"
							   ...
							   placeholder="省份">
						<input type="hidden" name="area_id"  id="hiddenSp" class="form-filter">
...
<script type="text/javascript">
	$(function(){
		var url = '<?php echo Yii::$app->urlManager->createUrl(['areast/index'])?>';
		var req = {};
