                ...
                <div class="portlet-title">
					...
					<div class="actions">
						<div class="btn-group ">
							...
							<a class="btn red btn-sm" href="<?=Yii::$app->urlManager->createUrl(['account/create','member_id'=>$user['member_id']])?>">
								<i class="fa fa-edit"></i> 更新资料</a>
						</div>
					</div>
                                ...
                                <div class="col-md-12 col-sm-12">
									<table  class="table table-bordered table-hover">
										...
										<tr>
											...
											<td><?= $seller['brank_name'] ?></td></tr>
										<tr>
											<th class="font-grey-salsa">开户账户</th>
											<td><?= $seller['account_holder'] ?></td></tr>
										<tr>
											<th class="font-grey-salsa">开户帐号</th>
											<td><?=  $seller['brank_account'] ?></td>
										</tr>
										</tbody>
									</table>
                                </div>
