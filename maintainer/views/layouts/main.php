...
<head>
	...
	<meta charset="utf-8" />
	<title>商家保险管理中心 | 乐换新</title>
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta content="width=device-width, initial-scale=1" name="viewport" />
	<meta content="商家保险管理中心#乐换新" name="description" />
	<meta content="商家保险管理中心#乐换新" name="author" />
...
<script type="text/javascript">
	...
	function submitFrom(form_data,url,returnUrl,time){
		if(!form_data || !url){
			alert('参数错误');
			return false;
		}
		...
		$.post(url, form_data, function (data) {
			...
			if(returnUrl || data.data.url){
				setTimeout(function () {
					window.location.href = data.data.url?data.data.url:returnUrl;
				}, time);
			}
