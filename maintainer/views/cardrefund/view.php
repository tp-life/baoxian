													...
													<table  class="table table-bordered table-hover">
														...
														<tbody>
                                                                ...
                                                                <?php if($card = $model->getErrCardInfo()): ?>
                                                                    ...
                                                                    <?php endforeach; ?>
                                                                <?php endif; ?>
																<?php if($model->status === \common\models\CardRefund::_RF_STATE_TO_DO || $model->status === \common\models\CardRefund::_RF_STATE_TO_WAIT): ?>
																<tr>
																	<th>退回处理</th>
																</tr>
                                                                <tr>
																...
																<tr>
																	<td></td>
																	<td>
																		<?= \yii\helpers\Html::a('确认并处理','#',['class'=>'btn font-green-sharp sbold','title'=>'确认并处理','id'=>'rf_confirm_done']) ?>
																	</td>
																	<td>
