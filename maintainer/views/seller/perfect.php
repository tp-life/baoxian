        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green bold uppercase">新增子账号</span>
                </div>
            </div>
            <form id="createSellerNext" class="form-horizontal" method="post">
                ...
                <input type="hidden" name="pid" value="<?=$model->seller_id?>" >
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="checkbox check_li" data-error-container="#form_2_services_error">
                                <?php if($model->is_insurance): ?>
                                <label>
                                    <input type="checkbox" value="1"
                                           name="is_type[]" <?= $seller['is_insurance'] == 1 ? 'checked="checked"' : '' ?> >
                                    保险销售 </label>
                                <?php endif; ?>
                                &nbsp;&nbsp;&nbsp;
                                <?php if($model->is_repair): ?>
                                <label>
                                    <input type="checkbox" value="2"
                                           name="is_type[]" <?= $seller['is_repair'] == 1 ? 'checked="checked"' : '' ?> />
                                    手机维修 </label>
                                <?php endif; ?>
                            </div>
...
//                },
                brank_account: {
//                    required: '请输入银行账号',
                    rangelength: '账号在15位到20位之间'

                },
				is_agreement:'请阅读并同意合同内容'
            },
            ...
            submitHandler: function (form) {
                ...
                submitFrom(form_data,'<?=Yii::$app->urlManager->createUrl('seller/create')?>','<?=Yii::$app->urlManager->createUrl('seller/index')?>');
                return false;
            }
        })
    });
